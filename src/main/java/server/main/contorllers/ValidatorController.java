 ...
 * ValidatorController
 * 
 * This is a controller that uses instances that extend IMapValidator. Each in
 * its own way validates certain cases. More details in the validators. The
 * controller serves to run all validators and to determine if the map is
 * correct.
 * 
 * Tasks: 1. Validate size of the map 2. Validate my castle position 3. Validate
 * the borders/edges 4. Validate the existence of the island
 * 
 * Using EdgeValidator, CastleValidator, IslandValidator & SizeValidator
 * instances to process tasks
 * 
